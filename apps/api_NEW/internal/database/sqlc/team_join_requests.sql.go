...
const deleteJoinRequestsByUserAndStatus = `-- name: DeleteJoinRequestsByUserAndStatus :exec
...
func (q *Queries) DeleteJoinRequestsByUserAndStatus(ctx context.Context, arg DeleteJoinRequestsByUserAndStatusParams) error {
	_, err := q.db.Exec(ctx, deleteJoinRequestsByUserAndStatus, arg.UserID, arg.Status)
	return err
}
...
const listTeamJoinRequestsByUserAndStatus = `-- name: ListTeamJoinRequestsByUserAndStatus :many
...
func (q *Queries) ListTeamJoinRequestsByUserAndStatus(ctx context.Context, arg ListTeamJoinRequestsByUserAndStatusParams) ([]TeamJoinRequest, error) {
	rows, err := q.db.Query(ctx, listTeamJoinRequestsByUserAndStatus, arg.UserID, arg.Status)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
