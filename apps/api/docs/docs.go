...
const docTemplate = `{
    ...
    "paths": {
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/sqlc.GetEventAttendeesWithDiscordRow"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/handlers.QueueConfirmationEmailFields",
                                        "summary": "request",
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/sqlc.Redeemable"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/handlers.CreateRedeemableRequest",
                                        "summary": "request",
        ...
        "/events/{eventId}/users/{userId}/update-rfid": {
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/handlers.UpdateRFID",
                                        "summary": "body",
                                        "description": "New RFID data"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "204": {
                        "description": "No Content - RFID updated successfully"
                    },
                    "400": {
                        "content": {
                            "application/json": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/handlers.UpdateRedeemableRequest",
                                        "summary": "request",
