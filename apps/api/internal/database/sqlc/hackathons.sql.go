...
INSERT INTO hackathons (
    ...
    $3, $4,
    $5, 
    coalesce($6, NULL::TIMESTAMPTZ), 
    coalesce($7, NULL::TIMESTAMPTZ),
    $8, $9,
    coalesce($10, NULL),
    coalesce($11, NULL),
    coalesce($12, NULL),
    coalesce($13, NULL::INT),     
    coalesce($14, NULL::TIMESTAMPTZ), 
...
type CreateHackathonParams struct {
	...
	EarlyApplicationOpen    interface{} `json:"early_application_open"`
	EarlyApplicationClose   interface{} `json:"early_application_close"`
...
func (q *Queries) CreateHackathon(ctx context.Context, arg CreateHackathonParams) (Hackathon, error) {
	row := q.db.QueryRow(ctx, createHackathon,
		...
		arg.AcceptEarlyApplications,
		arg.EarlyApplicationOpen,
		arg.EarlyApplicationClose,
		arg.StartTime,
		arg.EndTime,
		arg.Description,
		arg.Location,
