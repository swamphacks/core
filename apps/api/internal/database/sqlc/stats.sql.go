...
func (q *Queries) GetApplicationAgeSplit(ctx context.Context) (GetApplicationAgeSplitRow, error) {
	row := q.db.QueryRow(ctx, getApplicationAgeSplit)
...
func (q *Queries) GetApplicationGenderSplit(ctx context.Context) (GetApplicationGenderSplitRow, error) {
	row := q.db.QueryRow(ctx, getApplicationGenderSplit)
...
func (q *Queries) GetApplicationMajorSplit(ctx context.Context) ([]GetApplicationMajorSplitRow, error) {
	rows, err := q.db.Query(ctx, getApplicationMajorSplit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetApplicationRaceSplit(ctx context.Context) ([]GetApplicationRaceSplitRow, error) {
	rows, err := q.db.Query(ctx, getApplicationRaceSplit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetApplicationSchoolSplit(ctx context.Context) ([]GetApplicationSchoolSplitRow, error) {
	rows, err := q.db.Query(ctx, getApplicationSchoolSplit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetApplicationStatusSplit(ctx context.Context) (GetApplicationStatusSplitRow, error) {
	row := q.db.QueryRow(ctx, getApplicationStatusSplit)
