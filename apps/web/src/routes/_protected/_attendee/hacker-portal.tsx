...
const generateIdentifyIntent = (userId: string): string => {
  return `IDENT::${userId}`;
};
...
function RouteComponent() {
  ...
  const hackerGuideUrl =
    "https://swamphack.notion.site/swamphacks-xii-hacker-guide";
    ...
    <main className="max-w-5xl p-4 sm:p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-72 shrink-0">
          <Card className="relative overflow-hidden border-none bg-linear-to-br from-blue-600 to-indigo-700 p-1 shadow-xl">
      ...
      <div className="mt-3">
        <TeamFormation user={user} accepted />
      </div>
    </main>
  );
}
