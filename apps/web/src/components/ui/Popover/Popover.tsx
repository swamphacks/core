...
export const styles = tv({
  base: "bg-white dark:bg-neutral-900 dark:backdrop-saturate-200 forced-colors:bg-[Canvas] shadow-sm rounded-sm bg-clip-padding border border-black/10 dark:border-white/[15%] text-slate-700 dark:text-zinc-300",
  variants: {
    isEntering: {
