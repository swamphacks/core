	...
	},
	{
		...
		faqs: [
			...
			},
			{
				...
				a: "Yes, the J. Wayne Reitz Student Union has showers available on the Lower Level, which you can use during the open hours.",
			},
			{
				q: "Where can I sleep?",
				a: "Dedicated sleeping rooms will be available in the Reitz Union for participants. Space is limited, and rooms will be available on a first-come, first-served basis. If you'd like to continue working on your project overnight, designated workspaces will remain open throughout the night.",
			},
		],
	},
	{
							...
							{item.faqs.map((faqItem, questionIndex) => {
								...
								return (
									<div
										...
										key={itemKey}
										onClick={() =>
											toggle(sectionIndex, questionIndex)
										}
									>
										<button
